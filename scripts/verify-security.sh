...
file_not_contains_regex "scripts/flowise-production-release.py" "allow_self_bound|permit[[:space:]]*=[[:space:]]*None" "Production wrapper has no self-authorizing bootstrap permit bypass"
