...
router.post('/', checkPermission('evaluations:create'), checkPermission('credentials:view'), evaluationsController.createEvaluation)
router.get('/is-outdated/:id', checkPermission('evaluations:view'), evaluationsController.isOutdated)
router.post(
    '/run-again/:id',
    checkAnyPermission('evaluations:create,evaluations:run'),
